...
/// \param source The source of video frames to be sent to other clients
///
/// \param config Configurations of emitted video stream, e.g. simulcast
///
...
/// \param priority Relative priority for the subscription.
///
/// \param targetResolution A target resolution for the subscription. The actual receive resolution may vary.
///
